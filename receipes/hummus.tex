\begin{recipe}
    ...
    {Miriam's Hummus}
        ...
        \ingredients
            {% Zutatenliste
                \unit[2]{Dosen(265g)} & Kichererbsen, inkl. Flüßigkeit\\
        ...
        \preparation{
            \step Alle Zutaten in einen Hochleistungs Mixer geben wie einen Thermomix
        ...
        % \introduction{Dieses Rezept wurde speziell für einen runden Geburtstag kreiert.}
    \end{recipe}
